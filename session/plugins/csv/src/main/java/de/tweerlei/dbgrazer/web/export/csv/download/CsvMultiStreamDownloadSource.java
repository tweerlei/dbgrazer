 ...
 * @author Robert Wruck
 */
public class CsvMultiStreamDownloadSource extends AbstractCsvDownloadSource
	{
	 ...
	 */
	public CsvMultiStreamDownloadSource(CSVParameters params, RowSetProducer producer, String fileName, String noDataFound, DataFormatter fmt, SQLDialect dialect)
		{
