 ...
 */
@Service
public class FLVDownloadSourceCreator extends NamedBase implements ResultDownloader, FileDownloader, FileUploader
	{
	private static final CSVParameters FLV_PARAMS = new CSVParameters("", "", "", "\n");
	 ...
	 */
	@Autowired
	public FLVDownloadSourceCreator(DataFormatterFactory factory)
		{
		super("FLV");
	...
	public RowProducer createRowProducer(TableDescription info, InputStream input)
		{
		return (new CsvRowProducer(FLV_PARAMS, info, input, factory.getExportFormatter()));
		}
	
	@Override
	public DownloadSource getDownloadSource(String link, RowSet rs, String srcName)
		{
		return (new CsvDownloadSource(FLV_PARAMS, rs,
	...
	public DownloadSource getStreamDownloadSource(String link, RowProducer p, String srcName, String fileName)
		{
		return (new CsvStreamDownloadSource(FLV_PARAMS, p, fileName, factory.getMessage(MessageKeys.NO_DATA_FOUND), factory.getExportFormatter()));
		}
	...
	public DownloadSource getMultiStreamDownloadSource(String link, RowSetProducer p, String srcName, String fileName, SQLDialect dialect)
		{
		return (new CsvMultiStreamDownloadSource(FLV_PARAMS, p, fileName, factory.getMessage(MessageKeys.NO_DATA_FOUND), factory.getExportFormatter(), dialect));
		}
	}
