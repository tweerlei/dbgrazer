 ...
 */
@Service
public class CSVDownloadSourceCreator extends NamedBase implements ResultDownloader, FileDownloader, FileUploader
	{
	private static final CSVParameters CSV_PARAMS = new CSVParameters(";", "\"", "\"\"", "\n");
	 ...
	 */
	@Autowired
	public CSVDownloadSourceCreator(DataFormatterFactory factory)
		{
		super("CSV");
	...
	public RowProducer createRowProducer(TableDescription info, InputStream input)
		{
		return (new CsvRowProducer(CSV_PARAMS, info, input, factory.getExportFormatter()));
		}
	
	@Override
	public DownloadSource getDownloadSource(String link, RowSet rs, String srcName)
		{
		return (new CsvDownloadSource(CSV_PARAMS, rs,
	...
	public DownloadSource getStreamDownloadSource(String link, RowProducer p, String srcName, String fileName)
		{
		return (new CsvStreamDownloadSource(CSV_PARAMS, p, fileName, factory.getMessage(MessageKeys.NO_DATA_FOUND), factory.getExportFormatter()));
		}
	...
	public DownloadSource getMultiStreamDownloadSource(String link, RowSetProducer p, String srcName, String fileName, SQLDialect dialect)
		{
		return (new CsvMultiStreamDownloadSource(CSV_PARAMS, p, fileName, factory.getMessage(MessageKeys.NO_DATA_FOUND), factory.getExportFormatter(), dialect));
		}
	}
