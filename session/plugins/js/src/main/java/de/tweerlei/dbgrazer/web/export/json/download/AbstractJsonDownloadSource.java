 ...
 * @author Robert Wruck
 */
public abstract class AbstractJsonDownloadSource extends AbstractDownloadSource
	{
	 ...
	 */
	public AbstractJsonDownloadSource(String name)
		{
	...
	public final void write(OutputStream stream) throws IOException
		...
		try	{
			final JSONWriter cw = new JSONWriter(osw);
	 ...
	 */
	protected abstract void writeJson(JSONWriter cw) throws IOException;
	}
