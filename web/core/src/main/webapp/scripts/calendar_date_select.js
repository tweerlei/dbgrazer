  ...
  initButtonsDiv: function()
  {
    ...
    if (this.options.get("buttons")) {
      ...
      if (this.options.get("time")=="mixed" || !this.options.get("time")) b = buttons_div.build("a", {
          innerHTML: this._translations["Today"],
          href: "#",
      ...
      if (this.options.get("time")) b = buttons_div.build("a", {
        innerHTML: this._translations["Now"],
        href: "#",
      ...
      if (!this.options.get("embedded") && !this.closeOnClick())
      {
        ...
        buttons_div.build("a", { innerHTML: this._translations["OK"], href: "#", onclick: function() {this.close(); return false;}.bindAsEventListener(this) });
      }
      if (this.options.get('clear_button')) {
        buttons_div.build("span", {innerHTML: "&#160;|&#160;", className:"button_seperator"})
        buttons_div.build("a", { innerHTML: this._translations["Clear"], href: "#", onclick: function() {this.clearDate(); if (!this.options.get("embedded")) this.close(); return false;}.bindAsEventListener(this) });
      }
    }
  },
  refresh: function ()
