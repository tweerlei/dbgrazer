...
%><spring:form method="get" action="db/${currentConnection.linkName}/result.html" modelAttribute="model" onsubmit="return submitDialog(this);" onreset="return closeDialog();">
