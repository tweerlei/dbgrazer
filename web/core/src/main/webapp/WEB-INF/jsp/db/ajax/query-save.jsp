...
%><form action="db/${currentConnection.linkName}/query-save.html" method="post" onsubmit="return saveCustomQuery(\$F('f1-name'), \$F('statement'));" onreset="return closeDialog();">
	<dl>
		<dt><label for="f1-name"><fmt:message key="newName"/></label></dt>
		<dd><input id="f1-name" type="text" name="q" value="${fn:escapeXml(design)}"/></dd>
	</dl><hr/>
	<br/>
