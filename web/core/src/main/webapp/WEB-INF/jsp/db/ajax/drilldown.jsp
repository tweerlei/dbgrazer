...
<ui:panels level="${level}" items="${results}" var="rs" varKey="label" varLink="detailLink" varTarget="targetElement" varParams="detailParams" varParamString="detailParamString" name="panel"
