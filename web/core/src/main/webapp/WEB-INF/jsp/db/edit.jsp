...
>		<div class="menuitem"><span onclick="return toggleTextField('name');"><fmt:message key="rename"/></span></div>
		<div class="menuitem"><span onclick="return showConfirmDialog('<fmt:message key="delete"/>', Messages.deleteQueryText, 'db/${currentConnection.linkName}/remove-query.html', '${model.originalName}');"><fmt:message key="delete"/></span></div>
