...
%>
	...
	<div class="tab-page"><div class="tab-body">
		<form action="ws/${currentConnection.linkName}/query-fullexport.html" method="get" target="_blank" onreset="return goBack();">
			<dl>
				...
				<dd><input type="text" name="format"/> <a href="ws/${currentConnection.linkName}/dllinks.html" target="_blank">Supported formats</a></dd>
