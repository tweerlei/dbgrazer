...
public class LdapController
	 ...
	 */
	@Autowired
	public LdapController(QueryService queryService, QueryRunnerService runner,
	 ...
	 * @return Model
	 */
	@RequestMapping(value = "/db/*/submit-LDAP.html", method = RequestMethod.GET)
	 ...
	 * @return View
	 */
	@RequestMapping(value = "/db/*/submit-LDAP.html", method = RequestMethod.POST)
	public String fillCustomQueryForm(@ModelAttribute FormBackingObject fbo)
		...
		return ("redirect:submit-LDAP.html");
		}
	 ...
	 * @return Model
	 */
	@RequestMapping(value = "/db/*/ajax/submit-LDAP.html", method = RequestMethod.POST)
...
//			r.getFirstRowSet().getAttributes().putAll(querySettingsManager.getQuerySettings(null));
	 ...
	 * @return Model
	 */
	@RequestMapping(value = "/db/*/submit-LDAP-export.html", method = RequestMethod.POST)
	...
	private Result performQuery(String statement, String type, String label, int limit)
		{
