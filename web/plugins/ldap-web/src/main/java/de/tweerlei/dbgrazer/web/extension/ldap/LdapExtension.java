 ...
 */
package de.tweerlei.dbgrazer.web.extension.ldap;
...
/**
 * LDAP FrontendExtension
 * 
 * @author Robert Wruck
 */
@Service
@Order(10)
public class LdapExtension extends FrontendExtensionAdapter
	{
	 ...
	 */
	@Autowired
	public LdapExtension(FrontendHelperService frontendHelper, ConnectionSettings connectionSettings)
		{
		super("LDAP");
	...
	public List<ExtensionLink> getEditMenuExtensions()
		{
		if (!connectionSettings.getType().getName().equals(LdapConstants.LINKTYPE_LDAP))
		...
		if (connectionSettings.isBrowserEnabled())
			{
			ret.add(new ExtensionLink("ldapBrowser", frontendHelper.buildPath(MessageKeys.PATH_DB, connectionSettings.getLinkName(), "ldap.html", null), null, null));
			}
