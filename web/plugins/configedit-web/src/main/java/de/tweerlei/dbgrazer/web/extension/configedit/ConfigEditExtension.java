 ...
 */
package de.tweerlei.dbgrazer.web.extension.configedit;
...
@Service
@Order(9)
public class ConfigEditExtension extends FrontendExtensionAdapter
	{
	 ...
	 */
	@Autowired
	public ConfigEditExtension(UserSettings userSettings)
		{
		super("ConfigEdit");
	...
	public List<ExtensionLink> getAdminMenuExtensions()
		...
		if (userSettings.isReloadEnabled())
			ret.add(new ExtensionLink("config", "config.html", null, null));
