...
>	<div class="h1-actions">
	...
	<div id="tools-1" class="hidden"><div class="menucolumn">
		...
		<div class="menuitem"><span onclick="return showConfirmDialog('<fmt:message key="delete"/>', Messages.deleteUserText, 'remove-user.html', '${model.originalLogin}');"><fmt:message key="delete"/></span></div>
