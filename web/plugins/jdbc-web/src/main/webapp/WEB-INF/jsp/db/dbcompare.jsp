...
%>
	...
	<form id="h1-form" class="h1-actions" action="db/${currentConnection.linkName}/dbcompare.html" method="get" onsubmit="return showFormDialog(event, 'db:choose-schema', this, '<fmt:message key="change"/>');">
		<input type="hidden" name="backTo" value="dbcompare"/>
	...
	<div class="tab-page"><div id="zoomable1" class="tab-header">
		<spring:form id="submitform" cssClass="full" action="db/${currentConnection.linkName}/ajax/dbcompare.html" method="post" modelAttribute="model" target="formTarget" enctype="multipart/form-data" onsubmit="return submitForm(this);">
