...
%>
	...
	<form id="h1-form" class="h1-actions" action="db/${currentConnection.linkName}/dbcount2.html" method="get" onsubmit="return showFormDialog(event, 'db:choose-object', this, '<fmt:message key="change"/>');">
		<input type="hidden" name="backTo" value="dbcount2"/>
	...
	<div class="tab-page"><div id="zoomable1" class="tab-header">
		<spring:form id="submitform" cssClass="full" action="db/${currentConnection.linkName}/ajax/dbcount2.html" method="post" modelAttribute="model" onsubmit="return submitForm(this);">
