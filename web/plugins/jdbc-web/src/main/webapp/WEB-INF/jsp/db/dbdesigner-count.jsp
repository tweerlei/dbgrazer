...
%>
	...
	<div class="tab-page"><div id="zoomable1" class="tab-header">
		<spring:form id="submitform" cssClass="full" action="db/${currentConnection.linkName}/ajax/design-count.html" method="post" modelAttribute="model" onsubmit="return submitForm(this);">
			<dl>
