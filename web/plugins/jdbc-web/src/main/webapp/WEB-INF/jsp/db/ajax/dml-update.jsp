...
%><spring:form id="f1" action="db/${currentConnection.linkName}/dml-update.html" method="post" modelAttribute="model" onsubmit="return submitDML(this);" onreset="return closeDialog();">
