...
%><form id="f1" action="db/${currentConnection.linkName}/${backTo}.html" method="get" onsubmit="return submitDialog(this);" onreset="return closeDialog();">
...
>			</select></dd>
		<dt>&nbsp;</dt>
		<dd><input id="f1-submit" type="submit" value="<fmt:message key="apply"/>"<c:if test="${object == null}"> disabled="disabled"</c:if>/>
