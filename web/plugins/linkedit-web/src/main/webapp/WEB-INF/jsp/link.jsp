...
>	<div class="h1-actions">
	...
	<div id="tools-1" class="hidden"><div class="menucolumn">
		...
		<div class="menuitem"><span onclick="return showConfirmDialog('<fmt:message key="delete"/>', '<fmt:message key="deleteLinkText"/>', 'remove-link.html', { q: '${model.originalName}' });"><fmt:message key="delete"/></span></div>
