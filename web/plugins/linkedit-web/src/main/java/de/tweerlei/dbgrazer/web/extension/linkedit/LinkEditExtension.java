 ...
 */
package de.tweerlei.dbgrazer.web.extension.linkedit;
...
@Service
@Order(5)
public class LinkEditExtension extends FrontendExtensionAdapter
	{
	 ...
	 */
	@Autowired
	public LinkEditExtension(UserSettings userSettings)
		{
		super("LinkEdit");
	...
	public List<ExtensionLink> getAdminMenuExtensions()
		...
		if (userSettings.isLinkEditorEnabled())
			ret.add(new ExtensionLink("connections", "links.html", null, null));
