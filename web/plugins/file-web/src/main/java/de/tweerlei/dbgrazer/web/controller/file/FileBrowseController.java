...
public class FileBrowseController
	 ...
	 */
	@Autowired
	public FileBrowseController(QueryPerformerService runner, DataFormatterFactory factory, ResultTransformerService resultTransformer,
	 ...
	 * @return Model
	 */
	@RequestMapping(value = "/db/*/files.html", method = RequestMethod.GET)
	public Map<String, Object> showBrowser()
		...
		try	{
			final Result dirResult = runner.performCustomQuery(connectionSettings.getLinkName(), FileConstants.QUERYTYPE_DIRS, "", null, null, "dirs", true, null);
	 ...
	 * @return Model
	 */
	@RequestMapping(value = "/db/*/dir.html", method = RequestMethod.GET)
	 ...
	 * @return Model
	 */
	@RequestMapping(value = "/db/*/ajax/dir.html", method = RequestMethod.GET)
	...
	private Map<String, Object> showDirectoryInternal(String path)
		...
		try	{
			final Result fileResult = runner.performCustomQuery(connectionSettings.getLinkName(), FileConstants.QUERYTYPE_FILES, path, null, null, "files", true, null);
			final RowSet files = fileResult.getFirstRowSet();
			resultTransformer.translateRowSet(files, fmt);
	 ...
	 * @return Model
	 */
	@RequestMapping(value = "/db/*/ajax/dirtree.html", method = RequestMethod.GET)
	public Map<String, Object> showSubdirs(
		...
		try	{
			final Result dirResult = runner.performCustomQuery(connectionSettings.getLinkName(), FileConstants.QUERYTYPE_DIRS, path, null, null, "dirs", true, null);
			final RowSet dirs = dirResult.getFirstRowSet();
			resultTransformer.translateRowSet(dirs, fmt);
