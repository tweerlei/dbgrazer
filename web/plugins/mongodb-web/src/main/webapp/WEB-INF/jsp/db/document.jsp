...
%><c:set var="pageTitle" value="${collection}"/><%@
...
%>
	...
	<div class="h1-actions">
		...
		<a class="action" title="<fmt:message key="newWindow"/>" href="db/${currentConnection.linkName}/document.html?database=${database}&amp;collection=${collection}&amp;id=${id}" target="_blank"><fmt:message key="newWindowIcon"/></a>
	</div>
