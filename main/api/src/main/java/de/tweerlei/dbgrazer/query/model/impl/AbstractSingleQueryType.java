 ...
 * @author Robert Wruck
 */
public abstract class AbstractSingleQueryType extends AbstractQueryType
	{
	/**
	 ...
	 */
	protected AbstractSingleQueryType(String name, LinkType linkType, Map<String, Class<?>> attributes)
		{
