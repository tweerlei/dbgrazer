 ...
 * @author Robert Wruck
 */
public abstract class AbstractRowQueryType extends AbstractQueryType
	{
	/**
	 ...
	 */
	protected AbstractRowQueryType(String name, LinkType linkType, Map<String, Class<?>> attributes)
		{
