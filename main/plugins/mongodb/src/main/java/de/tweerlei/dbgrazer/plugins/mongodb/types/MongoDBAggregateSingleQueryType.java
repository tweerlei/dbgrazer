...
@Service
@Order(704)
public class MongoDBAggregateSingleQueryType extends AbstractSingleQueryType
	{
	private static final String NAME = "MONGODB_AGGREGATE_SINGLE";
	 ...
	 */
	@Autowired
	public MongoDBAggregateSingleQueryType(MongoDBLinkType linkType)
		{
