...
@Service
@Order(701)
public class MongoDBCommandQueryType extends AbstractTableQueryType
	{
	private static final String NAME = "MONGODB_COMMAND";
	 ...
	 */
	@Autowired
	public MongoDBCommandQueryType(MongoDBLinkType linkType)
		{
