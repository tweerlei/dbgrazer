 ...
 */
@Service
public class VerbatimSyntaxHighlightXMLToJSONFormatter extends XMLEncodedTextFormatter
	{
	/**
	 * Constructor
	 */
	public VerbatimSyntaxHighlightXMLToJSONFormatter()
		{
		super("XMLJSON-Highlight");
		}
	
	@Override
	public String format(String value)
		{
		final JSONHandler h = new SimpleJSONHandler(new SyntaxHighlightJSONPrinter());
