 ...
 */
@Service
public class StructuredJSONFormatter extends XMLEncodedTextFormatter
	{
	/**
	 * Constructor
	 */
	public StructuredJSONFormatter()
		{
		super("JSON-Structured");
		}
	
	@Override
	public String format(String value)
		{
		final JSONHandler h = new StructuredJSONHandler(new XmlEncodedJSONPrinter(false));
