...
/**
 * POST webservice request with MIME multipart content
 * 
 * @author Robert Wruck
 */
@Service
@Order(203)
public class MultipartQueryType extends AbstractSingleQueryType
	{
	private static final String NAME = "MULTIPART";
	 ...
	 */
	@Autowired
	public MultipartQueryType(WebserviceLinkType linkType)
		{
		super(NAME, linkType);
