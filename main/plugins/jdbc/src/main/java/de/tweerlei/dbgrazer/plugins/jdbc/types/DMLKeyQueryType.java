...
/**
 * DML statement that returns generated keys
 * 
 * @author Robert Wruck
 */
@Service
@Order(121)
public class DMLKeyQueryType extends AbstractTableQueryType
	{
	private static final String NAME = "DML_KEY";
	 ...
	 */
	@Autowired
	public DMLKeyQueryType(JdbcLinkType linkType)
		{
