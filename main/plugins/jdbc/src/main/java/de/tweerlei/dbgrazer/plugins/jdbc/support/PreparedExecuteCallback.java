 ...
 * @author Robert Wruck
 */
public class PreparedExecuteCallback implements PreparedStatementCallback
	{
	 ...
	 */
	public PreparedExecuteCallback(ResultSetExtractor rse, NativeJdbcExtractor nje)
		{
		this.rse = rse;
		this.nje = nje;
		}
