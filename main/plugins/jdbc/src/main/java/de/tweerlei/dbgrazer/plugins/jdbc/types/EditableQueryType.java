...
import de.tweerlei.dbgrazer.plugins.jdbc.impl.AggregateResultEnricher;
...
/**
 * Multiple rows, with editable filter/aggregation
 * 
 * @author Robert Wruck
 */
@Service
@Order(115)
public class EditableQueryType extends AbstractTableQueryType
	{
	private static final String NAME = "EDITABLE";
	
	private final AggregateResultEnricher postProcessor;
	
	/**
	 * Constructor
	 * @param linkType LinkType
	 * @param postProcessor ResultVisitor
	 */
	@Autowired
