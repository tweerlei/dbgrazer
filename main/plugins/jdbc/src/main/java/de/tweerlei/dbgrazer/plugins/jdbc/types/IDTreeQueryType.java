...
@Service
@Order(110)
public class IDTreeQueryType extends AbstractHierarchicalQueryType
	{
	private static final String NAME = "ID_TREE";
	 ...
	 */
	@Autowired
	public IDTreeQueryType(JdbcLinkType linkType)
		{
