...
import de.tweerlei.dbgrazer.plugins.jdbc.transformer.IDTreeTransformer;
...
@Service
@Order(111)
public class GroupedIDTreeQueryType extends AbstractHierarchicalQueryType
	{
	private static final String NAME = "GROUPED_ID_TREE";
	 ...
	 */
	@Autowired
	public GroupedIDTreeQueryType(JdbcLinkType linkType)
		{
