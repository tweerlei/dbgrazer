...
/**
 * Multiple rows, multiple columns, to be grouped by 1st column, editable
 * 
 * @author Robert Wruck
 */
@Service
@Order(119)
public class GroupedEditorQueryType extends AbstractTableQueryType
	{
	private static final String NAME = "GROUPED_EDITOR";
	 ...
	 */
	@Autowired
	public GroupedEditorQueryType(JdbcLinkType linkType)
		{
