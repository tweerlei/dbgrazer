...
/**
 * Multiple rows, multiple columns, to be grouped by 1st column
 * 
 * @author Robert Wruck
 */
@Service
@Order(106)
public class GroupedQueryType extends AbstractTableQueryType
	{
	private static final String NAME = "GROUPED";
	 ...
	 */
	@Autowired
	public GroupedQueryType(JdbcLinkType linkType)
		{
