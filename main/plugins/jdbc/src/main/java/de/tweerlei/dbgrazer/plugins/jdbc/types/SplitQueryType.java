...
/**
 * Multiple rows, multiple columns, to be split into N-1 RowSets containing the 1st and 1+Nth column each
 * 
 * @author Robert Wruck
 */
@Service
@Order(105)
public class SplitQueryType extends AbstractTableQueryType
	{
