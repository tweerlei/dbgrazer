...
import de.tweerlei.dbgrazer.plugins.jdbc.transformer.PivotTransformer;
...
/**
 * Multiple rows, multiple columns, pivoted
 * 
 * @author Robert Wruck
 */
@Service
@Order(109)
public class PivotQueryType extends AbstractTableQueryType
	{
