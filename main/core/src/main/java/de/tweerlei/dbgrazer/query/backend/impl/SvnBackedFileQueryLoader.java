...
/**
 * QueryLoader that uses an SvnFileAccess
 * 
 * @author Robert Wruck
 */
@Service("svnQueryLoader")
public class SvnBackedFileQueryLoader extends AbstractFileQueryLoader
	{
	/**
	 * Constructor
	 ...
	 */
	@Autowired
	public SvnBackedFileQueryLoader(ConfigFileStore store, ConfigAccessor configService, QueryPersister persister,
