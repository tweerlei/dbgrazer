...
/**
 * LinkLoader that uses an SvnFileAccess
 * 
 * @author Robert Wruck
 */
@Service("svnLinkLoader")
public class SvnBackedFileLinkLoader extends AbstractFileLinkLoader
	{
	/**
	 * Constructor
	 ...
	 */
	@Autowired
	public SvnBackedFileLinkLoader(ConfigFileStore store, ConfigAccessor configService, LinkPersister persister,
