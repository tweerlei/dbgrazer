...
/**
 * QueryLoader that uses a DirectFileAccess
 * 
 * @author Robert Wruck
 */
@Service("fileQueryLoader")
public class SimpleFileQueryLoader extends AbstractFileQueryLoader
	{
	/**
	 * Constructor
	 ...
	 */
	@Autowired
	public SimpleFileQueryLoader(ConfigFileStore store, ConfigAccessor configService, QueryPersister persister,
