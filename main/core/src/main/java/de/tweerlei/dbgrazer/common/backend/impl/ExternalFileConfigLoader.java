...
/**
 * ConfigLoader that uses an ExternalFileAccess
 * 
 * @author Robert Wruck
 */
@Service("externalConfigLoader")
public class ExternalFileConfigLoader extends AbstractFileConfigLoader
	{
	/**
	 * Constructor
	 ...
	 */
	@Autowired
	public ExternalFileConfigLoader(ConfigFileStore store,
