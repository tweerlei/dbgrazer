...
/**
 * ConfigLoader that uses an SvnFileAccess
 * 
 * @author Robert Wruck
 */
@Service("svnConfigLoader")
public class SvnBackedFileConfigLoader extends AbstractFileConfigLoader
	{
	/**
	 * Constructor
	 ...
	 */
	@Autowired
	public SvnBackedFileConfigLoader(ConfigFileStore store,
