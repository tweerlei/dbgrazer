...
/**
 * UserLoader that uses an ExternalFileAccess
 * 
 * @author Robert Wruck
 */
@Service("externalUserLoader")
public class ExternalFileUserLoader extends AbstractFileUserLoader
	{
	/**
	 * Constructor
	 ...
	 */
	@Autowired
	public ExternalFileUserLoader(ConfigFileStore store, ConfigAccessor configService,
