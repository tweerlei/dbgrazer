 ...
 * @author Robert Wruck
 */
public class SimpleXMLHandler implements XMLHandler
	{
	 ...
	 */
	public SimpleXMLHandler(Appendable a)
		{
	 ...
	 * @param pr XMLPrinter
	 */
	public SimpleXMLHandler(XMLPrinter pr)
		{
	 ...
	 * @param a Appendable to receive formatted output
	 */
	public SimpleXMLHandler(XMLPrinter pr, Appendable a)
		{
		this.sb = a;
		this.printer = pr;
		}
	...
	public void handleText(String text, int level)
		{
		try	{
			sb.append(printer.printText(text));
			}
		catch (IOException e)
			{
			throw new RuntimeException(e);
