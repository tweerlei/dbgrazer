...
/**
 * SessionThemeResolver that checks the requested theme against a list of theme names loaded from a ThemeEnumerator.
 * The first theme in the list is used as default theme, setDefaultThemeName has no effect.
 * 
 * @author Robert Wruck
 */
public class ValidatingSessionThemeResolver extends SessionThemeResolver
	{
	 ...
	 */
	public ValidatingSessionThemeResolver(ThemeEnumerator enumerator)
		{
